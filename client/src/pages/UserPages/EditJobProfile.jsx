...
function EditJobProfile() {
  ...
  const formik = useFormik({
    initialValues: {
      fullName: user?.jobProfile?.fullName,
      phone: user?.jobProfile?.phone,
      skills: user?.jobProfile?.skills,
      jobRole: user?.jobProfile?.jobRole,
      yearOfExperience: user?.jobProfile?.yearOfExperience,
    },
    ...
    onSubmit: (values) => {
      ...
      userRequest({
        url: apiEndPoints.updateJobProfile,
        method: "post",
        data: data,
      })
        .then((res) => {
